      ...
      864: () => {
        $(document).ready(function () {
              ...
              $.ajax({
                ...
                success: function (t) {
                  if (
                    ...
                    0 == data.prediction
                      ? $("#result").html(
                          '<div class="flex items-center p-4 mb-4 text-xs text-green-800 border border-green-300 rounded-lg bg-green-50 " role="alert">\n                <svg class="flex-shrink-0 inline w-4 h-4 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">\n                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>\n                </svg>\n                <span class="sr-only">Info</span>\n                <div>\n                    <span class="font-medium">Info !</span> This Packet is predicted as not Intrusion \n                </div>\n                </div>',
                        )
                      : $("#result").html(
                          '<div class="flex items-center p-4 mb-4 text-xs text-red-800 border border-red-300 rounded-lg bg-red-50 " role="alert">\n                <svg class="flex-shrink-0 inline w-4 h-4 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">\n                    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>\n                </svg>\n                <span class="sr-only">Info</span>\n                <div>\n                    <span class="font-medium">Danger !</span> This Packet is predicted as Intrusion  \n                </div>\n                </div>',
                        );
                  else {
                    for (
                      var e =
                    ...
                    (e += "</tbody></table></div>"), $("#result").html(e);
                  }
                },
                error: function () {
          ...
          document.addEventListener("DOMContentLoaded", function () {
            var t = document.getElementById("versionBtn"),
              e = document.getElementById("versionMenu");
            t.addEventListener("click", function (t) {
              t.stopPropagation(), e.classList.toggle("hidden");
            }),
